...
// #define delay(n) do { uint8_t count = (n); while (0 < count--) _delay_us(10); } while (0)
#define delay(n) do { delayMicroseconds(n); } while (0)
// #define CLK_DELAY delay(pp_params[PP_PARAM_CLK_DELAY])
#define CLK_DELAY DELAY
    ...
    while (ops < endp) {
        ...
        case OP_READ_ISP_BITS:
            ...
            while (0 < n--) {
                ...
                delay(pp_params[PP_PARAM_DELAY1]);

                send_bits(pp_params[PP_PARAM_CMD2], pp_params[PP_PARAM_CMD2_LEN]);
                delay(pp_params[PP_PARAM_DELAY2]);
                ...
                delay(pp_params[PP_PARAM_DELAY3]);
